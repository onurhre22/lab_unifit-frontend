    ...
    switch (cat) {
      case "팀":
        return {
          bg: "bg-blue-100",
          icon: (
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" className="h-5 w-5 text-blue-600">
              ...
              <path d="M7.49996 9.16667C9.34091 9.16667 10.8333 7.67428 10.8333 5.83333C10.8333 3.99238 9.34091 2.5 7.49996 2.5C5.65901 2.5 4.16663 3.99238 4.16663 7.67428 5.65901 9.16667 7.49996 9.16667Z"/>
            </svg>
          ),
        };
      case "멘토링":
        return {
          bg: "bg-green-100",
          icon: (
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" className="h-5 w-5 text-green-600">
      ...
      case "학업":
        return {
          bg: "bg-indigo-100",
          icon: (
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" className="h-5 w-5 text-indigo-600">
  ...
  return (
    <Link to={link} onClick={onClick} className="block">
      ...
      >
        ...
        <div className={`grid h-10 w-10 shrink-0 place-items-center rounded-full ${bg}`}>
          {icon}
        </div>
...
export default function Notification() {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, category: "팀", title: "새로운 팀 프로젝트 초대가 있습니다.", time: "2시간 전", read: false, link: "/team-project" },
    { id: 2, category: "멘토링", title: "멘토링 세션이 30분 후에 시작됩니다.", time: "3시간 전", read: false, link: "#" },
    { id: 3, category: "학업", title: "'소프트웨어 공학' 과제가 내일 마감입니다.", time: "1일 전", read: true, link: "#" },
    { id: 4, category: "팀", title: "팀원이 '요구사항 명세서'를 업데이트했습니다.", time: "2일 전", read: true, link: "/team-project" },
  ]);
        ...
        <div className="mt-8 space-y-4">
          {filteredNotifications.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-slate-500">'{activeTab}' 카테고리에 대한 알림이 없습니다.</p>
            </div>
          )}
        </div>
      </main>
