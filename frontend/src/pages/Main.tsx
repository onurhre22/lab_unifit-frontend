...
function ProgressCard() {
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm min-h-[460px]">
...
function PortfolioCard() {
  ...
  return (
    ...
    <div className="flex h-full flex-col rounded-2xl border border-slate-200 bg-white p-8 shadow-sm min-h-[460px]">
      ...
      <div className="text-sm font-medium text-slate-900">AI 포트폴리오 제작</div>
      ...
      <main className="-mt-16 rounded-t-[32px] bg-slate-50 pb-24 shadow-[0_-12px_40px_rgba(15,23,42,0.12)]">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-10">
          ...
          <section className="mt-12">
            ...
            <h2 className="text-2xl font-semibold text-slate-900">나의 현황 대시보드</h2>
